...
public class DealController {
    ...
    public ResponseEntity<List<DealSummaryDTO>> getAllWaitingList() {
    ...
    public ResponseEntity<List<DealSummaryDTO>> getPurchaseWaitingList(){
        return ResponseEntity.ok(List.of());
    }

    /** 4) 거래 중인 매물 - 판매 중 */
    @GetMapping("/waitinglist/onsale")
    public ResponseEntity<List<DealSummaryDTO>> getOnSaleWaitingList(){
        return ResponseEntity.ok(List.of());
    }
    ...
    public ResponseEntity<?> orderAnalysisReport(@RequestBody MemberShipOrderDTO dto){
        return ResponseEntity.ok().build();
    }
    ...
    public ResponseEntity<Void> startDeal(@RequestBody DealIntentDTO dto){
        return ResponseEntity.ok().build();
    }
    ...
    /** 12) 거래 상태 변경 */
    @PatchMapping("/status")
    public ResponseEntity<Void> changeDealStatus(@RequestBody DealStatusUpdateDto dto) {
        return ResponseEntity.noContent().build();
    }

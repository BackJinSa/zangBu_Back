...
//      )
  ...
  /// / /   @ApiResponses({ /       @ApiResponse(responseCode = "204", description = "거래 취소 성공"), /
  ///
...
//      )
  ...
  /// / /   @ApiResponses({ /       @ApiResponse(responseCode = "200", description = "문서 다운로드 성공"),
...
//      )
  ...
  /// / /   @ApiResponses({ /       @ApiResponse(responseCode = "200", description = "결제 페이지 이동
  /// 성공")
//  })

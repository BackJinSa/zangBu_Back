...
public class BuildingController {
    ...
    @PostMapping("")
    public ResponseEntity<?> viewDetail(ViewDetailRequest request)
    ...
    public ResponseEntity<?> bookMark(BookmarkRequest request) {
        buildingService.bookMarkService(request);
        return ResponseEntity.ok().build();
    }

    @DeleteMapping("/bookmark/{buildingId}")
    public ResponseEntity<?> bookMarkDelete(@PathVariable("buildingId") String buildingId) {
